...
class ExpendableAdapter(private val context: Context, private val groups: List<Group>) :
    ...
    override fun getGroupView(groupPosition: Int, isExpanded: Boolean, convertView: View?, parent: ViewGroup?): View {
        ...
        val groupw = getGroup(groupPosition) as Group
    ...
    override fun getChildView(groupPosition: Int, childPosition: Int, isLastChild: Boolean, convertView: View?, parent: ViewGroup?): View {
        ...
        if (group.recyclerViewItem != null) {
            ...
            if (childItem != null) {
                val adapter = ExAdapter(childItem.data) // Replace dataForRecyclerView with the appropriate data
